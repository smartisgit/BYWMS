 ...
 *
 * This is a passive model that results in launching the var|test view.
 */

$debug->add_debug_message('Entering the VAR|TEST mode.', DEBUG_MSG_TYPE_TRC,  __FILE__, __LINE__);
