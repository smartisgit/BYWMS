Ext.define('LES.usr.ucissueassignment.App', {
    namespace: 'LES.usr.ucissueassignment',
    ...
    views: ['MainView'],
    stores: ['MainStore','UcissueassignmentStore','UcissueassignmenttablesStore','UcissueassignmentseamlesStore','UcissueassignmentfilesStore'],
    ...
    initComponent: function() {
        this.title = 'OSSI Issue Assignment';
